...
To print 'Hello' and a newline to the screen, we define our entrypoint function, main, and in it call to the Force Command terminal-put-string function: fc_tputs. This sends the string of bytes to the terminal display to be interpretted by the ANSI terminal in Force Command.
...
- Entry Point Address - the address of our main function.
