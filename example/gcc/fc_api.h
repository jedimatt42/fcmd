...
#define FC_DSR_EA5LOAD 0x6096
#define FC_DSR_OPEN 0x609a
#define FC_DSR_CLOSE 0x609e
#define FC_DSR_READ 0x60a2
#define FC_DSR_WRITE 0x60a6
#define FC_DSR_STATUS 0x60aa
#define FC_DSR_RESET 0x60ae
#define FC_DSR_DELETE 0x60b2
#define FC_LVL2_INPUT 0x60b6
#define FC_LVL2_OUTPUT 0x60ba
#define FC_LVL2_PROTECT 0x60be
#define FC_LVL2_RENAME 0x60c2
#define FC_LVL2_SETDIR 0x60c6
#define FC_LVL2_MKDIR 0x60ca
#define FC_LVL2_RMDIR 0x60ce
#define FC_LVL2_RENDIR 0x60d2
#define FC_VARS_GET 0x60d6
#define FC_VARS_SET 0x60da
#define FC_TCP_CONNECT 0x60de
#define FC_TCP_CLOSE 0x60e2
#define FC_TCP_READ_SOCKET 0x60e6
#define FC_TCP_SEND_CHARS 0x60ea
#define FC_TIPI_ON 0x60ee
#define FC_TIPI_OFF 0x60f2
#define FC_TIPI_SENDMSG 0x60f6
#define FC_TIPI_RECVMSG 0x60fa
