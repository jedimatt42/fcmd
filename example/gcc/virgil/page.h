...
FC_SAMS_VOIDBANKED(1, init_page, (), ());
FC_SAMS_VOIDBANKED(1, page_clear_lines, (), ());
FC_SAMS_VOIDBANKED(1, page_load, (), ());
FC_SAMS_VOIDBANKED(1, page_from_buf, (char* buf, int len), (buf, len));

FC_SAMS_BANKED(1, struct Line*, page_get_line, (int idx), (idx));
