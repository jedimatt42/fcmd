...
DECLARE_BANKED_VOID(setstrtok, BANK(1), bk_setstrtok, (char* str), (str))
DECLARE_BANKED(strtok, BANK(1), char *, bk_strtok, (char *str, char *delim), (str, delim))
DECLARE_BANKED(strtokpeek, BANK(1), char *, bk_strtokpeek, (char *str, char *delim), (str, delim))
DECLARE_BANKED(strchr, BANK(1), char *, bk_strchr, (char *str, int delim), (str, delim))
DECLARE_BANKED(strcspn, BANK(1), int, bk_strcspn, (char *string, char *chars), (string, chars))
