...
SUPPORT=FC/LOAD FC/FCMD FC/FCMDXB FC/BIN/FTP FC/BIN/SAY FC/BIN/SAMPLE
...
SUBDIRS=charset fcmenu ftp say telnet
...
$(FNAME).DSK: subdirs support
	python3 $(XDM99) $(FNAME).DSK -X 360 -t -a FC/BIN/FCMENU FC/BIN/FTP FC/BIN/TELNET FC/BIN/SAY FC/BIN/SAMPLE
