...
SUBDIRS=hello samshello charset diskimage fcmenu ftp say telnet virgil font tuidemo graphicsdemo apitest sysinfo strtest strfmt listtest vartest exectest termtest termread vdptool audio sndtest exittest samstest dsrtest
