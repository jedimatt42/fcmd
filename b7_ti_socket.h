...
DECLARE_BANKED(tls_connect, BANK(7), unsigned int, bk_tls_connect, (unsigned int socketId, unsigned char* hostname, unsigned char* port), (socketId, hostname, port))
DECLARE_BANKED(tls_close, BANK(7), unsigned int, bk_tls_close, (unsigned int socketId), (socketId))
DECLARE_BANKED(tls_send_chars, BANK(7), int, bk_tls_send_chars, (unsigned int socketId, unsigned char* buf, int size), (socketId, buf, size))
DECLARE_BANKED(tls_read_socket, BANK(7), int, bk_tls_read_socket, (unsigned int socketId, unsigned char* buf, int bufsize), (socketId, buf, bufsize))
